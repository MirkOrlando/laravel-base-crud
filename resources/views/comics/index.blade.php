                ...
                <tbody>
                    ...
                    @foreach ($comics as $comic)
                        ...
                        <p style="max-width: 400px;" class="text-truncate">
                            ...
                            {{-- <td>{{ $comic->type }}</td> --}}
                            <td class="actions">
                                <a class="btn btn-primary py-0 px-1" href="{{ route('comics.show', $comic->id) }}"><svg
                                ...
                                <a class="btn btn-secondary py-0 px-1" href="{{ route('comics.edit', $comic->id) }}">
                                ...
                                <button type="button" class="btn btn-danger py-0 px-1" data-bs-toggle="modal"
                                ...
                                <div class="modal fade" id="delete-comic{{ $comic->id }}" tabindex="-1" role="dialog"
                                    aria-labelledby="modelTitleId-{{ $comic->id }}" aria-hidden="true">
